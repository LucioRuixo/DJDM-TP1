...
/// </summary>
public class CabComp : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		else
		{
			if(Girando)
			{
                TempoDurGir += UnityEngine.Time.deltaTime;
			...
			{
                TempoEntreGiro += UnityEngine.Time.deltaTime;
	...
	void FixedUpdate () 
	{
		this.transform.position += transform.forward * UnityEngine.Time.fixedDeltaTime * Vel;
	}
