...
public class CarCamera : MonoBehaviour
{
	...
	void FixedUpdate()
	{
        currentVelocity = Vector3.Lerp(prevVelocity, target.GetComponent<Rigidbody>().velocity, velocityDamping * UnityEngine.Time.deltaTime);
		currentVelocity.y = 0;
	...
	void LateUpdate()
	{
		float speedFactor = Mathf.Clamp01(target.GetComponent<Rigidbody>().velocity.magnitude / 70.0f);
